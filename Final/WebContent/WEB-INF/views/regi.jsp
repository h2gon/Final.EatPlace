...
.content_table th { background-color:#c53211; color:#FFFFFF; line-height: 1.7em; font-weight:normal;}
			...
			<div style="width: 502px; height: 166px; margin-left: auto; margin-right: auto;
				...
				<div id="login_wrap">
					...
					<tr>
						...
						<td>
							...
							<a href="#none" id="_btnGetId" title="회원가입">
								<img alt="중복확인" src="img/idcheck.png">
							</a>
							<div id="_rgetid"></div>
						</td>
					</tr>
					...
					<tr>
						<th>이름</th>
						<td>
							<input type="text" name="name" id="_name" size="30" data-msg="성함을 "> 
						</td>
					</tr>
					...
					<tr>
						<th>닉네임</th>
						<td>
							<input type="text" name="nickname" id="_nickname" size="30" data-msg="닉네임을 "> 
						</td>
					</tr>
					...
					<tr>
						...
						<a href="#none" id="_btnRegi" title="회원가입">
							<img alt="회원가입" src="./img/regi.jpg">						
						</a>
						
						<a href="#none" id="_btnLogin" title="로그인">
							<img alt="로그인" src="img/login_btn.jpg">						
						</a>					
